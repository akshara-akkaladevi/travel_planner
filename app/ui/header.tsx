        ...
        <header className="flex items-center justify-between p-4 bg-blue-900 text-white">
            ...
            <nav>
                <ul className="flex gap-4">
                    <li>
                        <Button variant="link" className="text-white"><a href="/">Home</a></Button>
                    </li>
                    <li>
                    ...
                    {loading ? (
                        ...
                        <li>
                            <Button variant="link" className="text-white" onClick={handleLogout}>Logout</Button>
                        </li>
                    ) : (
                        <li>
                            <Button variant="link" className="text-white"><a href="/login">Sign In</a></Button>
                        </li>
                    )}
                </ul>
            </nav>
